...
#define HREF_DEFAULT 0x00 // default href
#define HREF_RIGHT_ADJUSTED 0x80 // right edge adjust
#define HREF_LEFT_ADJUSTED 0x40 // left edge adjust
#define HREF_BOTH_ADJUSTED 0xC0 // both edge adjust

#define REG_TSLB 0x3a     /* lots of stuff */
#define TSLB_YLAST 0x04   /* UYVY or VYUY - see com13 */
#define TSLB_YFIRST 0x00  //YUYV or YVYU
#define TSLB_AUTO_WINDOW_ENABLE 0x01 
#define TSLB_AUTO_WINDOW_DISABLE 0x00
